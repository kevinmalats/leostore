@extends('plantillas.productoslistar')
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <p class="category">Items seleccionados</p>
                        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @endif
                                @if($productos->categoria=='2')
                                <span class="label label-primary">PRENDAS</span>
                                @endif
                                @if($productos->categoria=='3')
                    ...
                    <div class="form-group" action="{{route('listaproducto')}}" method="get">
